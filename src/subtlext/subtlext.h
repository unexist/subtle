...
#define GET_ATTR(owner, name, value) \
    if (NIL_P(value = rb_iv_get(owner, name))) \
        return Qnil;
...
/* color.c {{{ */
unsigned long subextColorPixel(VALUE red, VALUE green, VALUE blue,
                               XColor *xcolor); ///< Get pixel value
...
VALUE subextSubtlextParse(VALUE value, char *buf, int len, int *flags); ///< Parse arguments
...
int subextSubtlextFindString(char *prop_name, char *source, char **name,
                             int flags); ///< Find string id
VALUE subextSubtlextFindObjects(char *prop_name, char *class_name, char *source, int flags,
                                int first); ///< Find objects
VALUE subextSubtlextFindWindows(char *prop_name, char *class_name, char *source, int flags,
                                int first); ///< Find objects
VALUE subextSubtlextFindObjectsGeometry(char *prop_name, char *class_name, char *source, int flags,
                                        int first); ///< Find objects with geometries
/* }}} */
