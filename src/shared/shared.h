...
#define RINT(r) \
    printf("<%s:%d> %s: x=%d, y=%d, width=%d, height=%d\n", __FILE__, __LINE__, #r, r.x, r.y, \
           r.width, r.height); ///< Print a XRectangle
...
/* Property {{{ */
char *subSharedPropertyGet(Display *disp, Window win, Atom type, Atom prop,
                           unsigned long *size); ///< Get window property
char **subSharedPropertyGetStrings(Display *disp, Window win, Atom prop,
                                   int *nlist); ///< Get window property list
void subSharedPropertySetStrings(Display *disp, Window win, Atom prop, char **list,
                                 int nlist); ///< Set window property list
void subSharedPropertyName(Display *disp, Window win, char **name,
                           char *fallback); ///< Get window name
void subSharedPropertyClass(Display *disp, Window win, char **inst,
...
void subSharedDrawIcon(Display *disp, GC gc, Window win, int x, int y, int width, int height,
                       long fg, long bg, Pixmap pixmap, int bitmap); ///< Draw icons
void subSharedDrawString(Display *disp, GC gc, SubFont *f, Window win, int x, int y, long fg,
                         long bg, const char *text, int len); ///< Draw text
/* }}} */
...
int subSharedStringWidth(Display *disp, SubFont *f, const char *text, int len, int *left,
                         int *right, int center); ///< Get text width
/* }}} */
